...
Ray::Ray(int inDepth, glm::vec3 inOrigin, glm::vec3 inDirection, glm::vec4 inStrength, float inNear, float inFar) :
...
Ray::Ray(int inDepth, glm::vec4 inOrigin, glm::vec4 inDirection, glm::vec4 inStrength, float inNear, float inFar) :
